            ...
            <div class="TzLikeButtonInner">
                    ...
                    <div class="FacebookButton">
                        <script type="text/javascript">
                            (function(d, s, id) {
                                ...
                                js.src = "//connect.facebook.net/<?php echo $langcode;?>/all.js#appId=177111755694317&xfbml=1";
                                fjs.parentNode.insertBefore(js, fjs);
                            }(document, 'script', 'facebook-jssdk'));
                        </script>
                        <div class="fb-like" data-send="false" data-width="200" data-show-faces="true"
                             data-layout="button_count" data-href="<?php echo $item ->fullLink; ?>"></div>
                    </div>
                <?php endif; ?>
                ...
                if($params -> get('show_twitter_button',1)):
                    ...
                    <div class="TwitterButton">
                        <a href="https://twitter.com/share" data-url="<?php echo $item ->fullLink; ?>"
                ...
                if($params -> get('show_google_button',1) == 1):
                    ...
                    <div class="GooglePlusOneButton">
                        <div class="g-plusone" data-size="medium" data-href="<?php echo $item -> fullLink; ?>"></div>
                        <script type="text/javascript">
                            (function() {
                ...
                if($params -> get('show_pinterest_button',1)):
                    ...
                    <div class="PinterestButton">
                        <a href="//www.pinterest.com/pin/create/button/?url=<?php echo urlencode($item -> fullLink);?>"
                ...
                if($params -> get('show_linkedin_button',1)):
                    ...
                    <div class="LinkedinButton">
                        ...
                        <script type="IN/Share" data-url="<?php echo $item -> fullLink; ?>" data-counter="right"></script>
                    </div>
                <?php endif;?>
