...
if(isset($item) && $item && isset($image) && $image && isset($image -> url) && !empty($image -> url)):
    if($params -> get('mt_image_related_show_image', 1) && isset($image -> related_url) && $image -> related_url):
?>
