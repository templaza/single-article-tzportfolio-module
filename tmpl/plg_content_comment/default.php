...
if(isset($item) && $item && $params -> get('show_comment', 1)):
    $lang           = JFactory::getLanguage();
    $addonParams    = $this -> params;
?>
...
<div class="tz_portfolio_plus_comment">
    ...
    <script type="text/javascript">
        var disqus_shortname = "<?php echo $addonParams -> get('disqus_subdomain','templazatoturials'); ?>";
        var disqus_url      = "<?php echo $item -> fullLink;?>";
        var disqus_developer = 1;
        var disqus_identifier ="<?php echo $addonParams -> get('disqus_subdomain','templazatoturials').'-'.$item -> id;?>";
            (function() {
    ...
    ?>
    <div class="tz_comment_notice"><?php echo JText::sprintf('PLG_CONTENT_COMMENT_NOTICE', ucfirst($params -> get('comment_type', 'facebook')));?></div>
    <?php
        }
    }?>
</div>
